...
Description:
    1. main.py should be a ChatGPT-like interface:
        a. Tab 1 is a chat interface, just as it looks on ChatGPT
        b. Tab 2 is a video feed instead of chat history, and the predicted
           emotion will go in place where the input field usually goes
    2. Qt is the UI framework used for this project
...
Folder structure (subject to change due to Qt):
    ...
    - models
        - logs.txt (storing parameters used to train given model)
